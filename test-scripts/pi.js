...
// Example input
const digit = [(typeof input === 'undefined') ? 100000 : input];
// Call the function with example input
console.log(`PI computation with ${digit} digits:`);
const time = Date.now();
const result = main(digit);
console.log(`Calculated digits: ${result.length-2}, last 5 digits: ${result.slice(-5)}`);
